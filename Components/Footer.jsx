...
const Footer = () => {
  return (
    <footer className='text-white py-20 bg_gradient'>
      <div className='container mx-auto px-20 lg:px20 py-20 flex flex-col gap-10 md:flex-row justify-between border-t border-slate-800'>
        <div className='flex'>
      ...
      <div className="flex items-center justify-center py-10">
        <span className="text-gray-400 leading-10">IvyMonique &copy; 2023</span>
      </div>
    </footer>
  )
}
